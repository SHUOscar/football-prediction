...
all_matches = [
    ...
    {"id": "周三002", "home": "首尔FC", "away": "神户胜利", "half": "0:1", "full": "0:1", "result": "客胜", "result_code": 2, "initial_odds": {"home": 3.05, "draw": 2.98, "away": 2.15}, "final_odds": {"home": 3.37, "draw": 2.90, "away": 2.05}, "changes_1x2": 8},
    {"id": "周三003", "home": "大阪钢巴", "away": "叻武里", "half": "0:0", "full": "1:1", "result": "平局", "result_code": 1, "initial_odds": {"home": 1.18, "draw": 5.50, "away": 10.00}, "final_odds": {"home": 1.14, "draw": 5.80, "away": 12.50}, "changes_1x2": 3},
]

print("="*60)
print("更新模型 - 加入今天001-003")
print("="*60)
...
print(f"  规则模型: {rule_accuracy:.1f}% ({rule_correct}/{len(features_list)})")

# 分析今天的新增比赛
print("\n今天001-003分析:")
for match in all_matches[-3:]:
    print(f"  {match['id']}: {match['home']} vs {match['away']} = {match['result']}")

print("\n" + "="*60)
print("总结")
print("="*60)
print(f"样本总数: {len(all_matches)}")
print(f"规则模型准确率: {rule_accuracy:.1f}%")
