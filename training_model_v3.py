...
# ==================== 3月3日新数据 ====================
march_3 = [
    {"id": "周一003", "home": "比萨", "away": "博洛尼亚", "half": "0:0", "full": "0:1", "result": "客胜", "result_code": 2, "initial_odds": {"home": 3.65, "draw": 3.15, "away": 1.86}, "final_odds": {"home": 3.90, "draw": 3.15, "away": 1.80}, "changes_1x2": 5, "changes_handicap": 5},
    {"id": "周一005", "home": "乌迪内斯", "away": "佛罗伦萨", "half": "1:0", "full": "3:0", "result": "主胜", "result_code": 0, "initial_odds": {"home": 3.08, "draw": 3.11, "away": 2.07}, "final_odds": {"home": 3.20, "draw": 3.11, "away": 2.02}, "changes_1x2": 2, "changes_handicap": 3},
    {"id": "周一006", "home": "亚眠", "away": "特鲁瓦", "half": "0:0", "full": "0:2", "result": "客胜", "result_code": 2, "initial_odds": {"home": 4.35, "draw": 3.45, "away": 1.64}, "final_odds": {"home": 4.50, "draw": 3.54, "away": 1.60}, "changes_1x2": 4, "changes_handicap": 4},
    {"id": "周一007", "home": "伯明翰", "away": "米堡", "half": "0:2", "full": "1:3", "result": "客胜", "result_code": 2, "initial_odds": {"home": 2.33, "draw": 3.22, "away": 2.57}, "final_odds": {"home": 2.78, "draw": 3.32, "away": 2.14}, "changes_1x2": 7, "changes_handicap": 6},
    ...
    {"id": "周一009", "home": "吉维森特", "away": "本菲卡", "half": "0:1", "full": "1:2", "result": "客胜", "result_code": 2, "initial_odds": {"home": 5.20, "draw": 3.58, "away": 1.52}, "final_odds": {"home": 6.10, "draw": 4.15, "away": 1.38}, "changes_1x2": 7, "changes_handicap": 5},
    {"id": "周二001", "home": "墨尔本城", "away": "布里兰", "half": "0:1", "full": "1:1", "result": "平局", "result_code": 1, "initial_odds": {"home": 2.25, "draw": 2.95, "away": 2.90}, "final_odds": {"home": 2.14, "draw": 2.95, "away": 3.10}, "changes_1x2": 8, "changes_handicap": 7},
    {"id": "周二003", "home": "江原FC", "away": "町田泽维", "half": "0:0", "full": "0:0", "result": "平局", "result_code": 1, "initial_odds": {"home": 3.60, "draw": 3.10, "away": 1.89}, "final_odds": {"home": 4.31, "draw": 2.95, "away": 1.79}, "changes_1x2": 6, "changes_handicap": 6},
]

# ==================== 3月4日新数据 ====================
march_4 = [
    {"id": "周二004", "home": "奈梅亨", "away": "埃因霍温", "half": "1:0", "full": "3:2", "result": "主胜", "result_code": 0, "initial_odds": {"home": 3.80, "draw": 4.10, "away": 1.61}, "final_odds": {"home": 3.90, "draw": 4.25, "away": 1.57}, "changes_1x2": 6, "changes_handicap": 6},
    {"id": "周二005", "home": "伯恩茅斯", "away": "布伦特", "half": "0:0", "full": "0:0", "result": "平局", "result_code": 1, "initial_odds": {"home": 2.25, "draw": 3.37, "away": 2.58}, "final_odds": {"home": 2.35, "draw": 3.37, "away": 2.46}, "changes_1x2": 3, "changes_handicap": 3},
    {"id": "周二006", "home": "埃弗顿", "away": "伯恩利", "half": "1:0", "full": "2:0", "result": "主胜", "result_code": 0, "initial_odds": {"home": 1.46, "draw": 3.77, "away": 5.60}, "final_odds": {"home": 1.41, "draw": 3.90, "away": 6.10}, "changes_1x2": 3, "changes_handicap": 3},
    {"id": "周二009", "home": "科莫", "away": "国际米兰", "half": "0:0", "full": "0:0", "result": "平局", "result_code": 1, "initial_odds": {"home": 2.70, "draw": 3.20, "away": 2.24}, "final_odds": {"home": 2.84, "draw": 3.10, "away": 2.20}, "changes_1x2": 5, "changes_handicap": 4},
    {"id": "周二010", "home": "巴萨", "away": "马竞", "half": "2:0", "full": "3:0", "result": "主胜", "result_code": 0, "initial_odds": {"home": 1.39, "draw": 4.85, "away": 4.90}, "final_odds": {"home": 1.37, "draw": 4.95, "away": 5.08}, "changes_1x2": 2, "changes_handicap": 3},
    {"id": "周二011", "home": "斯特拉斯", "away": "兰斯", "half": "1:0", "full": "2:1", "result": "主胜", "result_code": 0, "initial_odds": {"home": 1.39, "draw": 4.05, "away": 6.15}, "final_odds": {"home": 1.41, "draw": 4.00, "away": 5.88}, "changes_1x2": 2, "changes_handicap": 2},
    {"id": "周二012", "home": "狼队", "away": "利物浦", "half": "1:0", "full": "2:1", "result": "主胜", "result_code": 0, "initial_odds": {"home": 6.00, "draw": 4.50, "away": 1.35}, "final_odds": {"home": 6.25, "draw": 4.60, "away": 1.33}, "changes_1x2": 2, "changes_handicap": 1},
]

# 合并所有数据
all_matches = march_1_2 + march_3 + march_4

print("="*60)
print("完整数据更新训练模型")
print("="*60)
print(f"\n历史数据(3月1-2日): {len(march_1_2)} 场")
print(f"新增数据(3月3日): {len(march_3)} 场")
print(f"新增数据(3月4日): {len(march_4)} 场")
print(f"总样本数: {len(all_matches)} 场")
...
之前模型:
  - 样本数: {old_total}
  - 准确率: {old_rule_accuracy}%

当前模型:
  - 样本数: {len(all_matches)}
  - 市场概率: {market_accuracy:.1f}%
  - 规则模型: {rule_accuracy:.1f}%
  - 强化规则: {enhanced_accuracy:.1f}%

变化:
  - 样本增加: +{len(all_matches) - old_total} 场
  - 规则模型准确率变化: {rule_accuracy - old_rule_accuracy:+.1f}%
""")

# 保存更新后的数据
output = {
    "total_matches": len(all_matches),
    "historical_matches": len(march_1_2),
    "march_3_matches": len(march_3),
    "march_4_matches": len(march_4),
    "home_wins": home_wins,
    "draws": draws,
    "away_wins": away_wins,
    ...
    "old_rule_accuracy": old_rule_accuracy,
    "matches": features_list
}

with open("training_data_full.json", "w", encoding="utf-8") as f:
    json.dump(output, f, ensure_ascii=False, indent=2)

print("完整数据已保存到 training_data_full.json")
